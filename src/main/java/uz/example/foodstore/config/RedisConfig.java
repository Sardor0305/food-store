    ...
    public RedisCacheManagerBuilderCustomizer redisCacheManagerBuilderCustomizer() {
        return builder -> {
            var productConf = RedisCacheConfiguration.defaultCacheConfig()
                    .entryTtl(Duration.ofSeconds(productsEntryTtl));
            builder.withCacheConfiguration(CacheName.PRODUCT.name(), productConf);
            builder.withCacheConfiguration(CacheName.PRODUCT_BY_CATEGORY_ID.name(), productConf);
        };
    }
}
